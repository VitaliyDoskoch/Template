...
import com.doskoch.movies.core.components.ui.base.pager.behavior.PagerAdapterBehavior
import com.doskoch.movies.core.components.ui.base.pager.itemsManager.PagerItemsManager

open class BaseTabPagerAdapter(
    fragmentManager: FragmentManager,
    behavior: PagerAdapterBehavior,
    items: List<Pair<String, Fragment>> = emptyList()
) : FragmentPagerAdapter(fragmentManager, behavior.constant) {
