...
fun placeholderImageOf(throwable: Throwable): CorePlaceholder.Image {
    return when (throwable) {
        is com.doskoch.api.the_movie_db.components.exceptions.NoInternetException -> CorePlaceholder.Image(
            R.drawable.ic_placeholder_no_internet,
            "1:1"
        )
        is com.doskoch.api.the_movie_db.components.exceptions.NetworkException -> CorePlaceholder.Image(R.drawable.ic_placeholder_no_internet, "1:1")
